        ...
        try {
            ...
            for (Entry entry : entries) {
                ...
                for (FilePath src : paths) {
                    ...
                    records.add(profile.upload(build, listener, bucket, entry.destinationFile, src, searchPathLength, escapedMetadata, storageClass, selRegion, entry.uploadFromSlave, entry.managedArtifacts, entry.useServerSideEncryption, entry.flatten, entry.gzipFiles));
                }
