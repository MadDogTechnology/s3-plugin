...
public class S3Profile {
    ...
    public FingerprintRecord upload(AbstractBuild<?,?> build, final BuildListener listener, String bucketName, String destinationFile, FilePath filePath, int searchPathLength, Map<String, String> userMetadata,
